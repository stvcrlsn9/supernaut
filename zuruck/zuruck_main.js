...
var fullbeams = new Image();
var moon = new Image();
var halfbeams = new Image();
var copyshadow = new Image();
var copy = new Image();
var astroshadow = new Image();
var astronaut = new Image();
var shapeshadow = new Image();
...
var layer_list = [
	{
		'image': background,
		'src': 'img/layer_1_background.png',
		'z_index': -3.5,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
	...
	{
		'image': copyshadow,
		'src': 'img/layer_5_copyshadow.png',
		'z_index':-2,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 1
	...
	{
		'image': astroshadow,
		'src': 'img/layer_7_astroshadow.png',
		'z_index': -1,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 1
	...
	},
  {
	...
	{
		'image': shapeshadow,
		'src': 'img/layer_9_shapeshadow.png',
		'z_index': 1,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 1
