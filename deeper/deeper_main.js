...
var logo = new Image();
var backsplash = new Image();
var topsplash = new Image();
var copy1 = new Image();
var body = new Image();
var frame = new Image();
var copy2 = new Image();
var bottomsplash = new Image();
...
var layer_list = [
	...
	{
		'image': backsplash,
		'src': 'img/layer_3_backsplash.png',
		'z_index': -3,
		'position': {x: 0, y: 0},
		'blend': 'color-burn',
		'opacity': 1
  ...
  {
		'image': bottomsplash,
		'src': 'img/layer_9_bottomsplash.png',
		'z_index': 2,
		'position': {x: 0, y: 0},
		'blend': 'screen',
		'opacity': 0.75
