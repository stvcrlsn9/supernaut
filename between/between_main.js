...
var moon = new Image();
var swirl = new Image();
var topcopy = new Image();
var head = new Image();
var bottomcopy = new Image();
...
var layer_list = [
	...
	{
		'image': bottomcopy,
		'src': 'img/layer_6_bottomcopy.png',
		'z_index': -0.5,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
