...
var me = new Image();
var bottomslime = new Image();
var middleslime = new Image();
var copy = new Image();
var topslime = new Image();
var face = new Image();
var frame = new Image();
var logo = new Image();
...
var layer_list = [
	...
	{
		'image': bottomslime,
		'src': 'img/layer_3_bottomslime.png',
		'z_index': -2,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 1
	...
	{
		'image': middleslime,
		'src': 'img/layer_4_middleslime.png',
		'z_index': -2,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
