...
var rose = new Image();
var copy_shadow = new Image();
var copy = new Image();
var glitch = new Image();
var main_bubble = new Image();
var frame = new Image();
var logo = new Image();
var clear_bubbles = new Image();
var cloudy_bubbles = new Image();
...
var layer_list = [
	...
	{
		'image': copy_shadow,
		'src': 'img/layer_3_copy_shadow.png',
		'z_index': -4,
		'position': {x: 0, y: 0},
		'blend': 'multiply',
		'opacity': 1
	...
	{
		'image': main_bubble,
		'src': 'img/layer_6_main_bubble.png',
		'z_index':-1,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
  ...
  {
		'image': clear_bubbles,
		'src': 'img/layer_9_clear_bubbles.png',
		'z_index': 1,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 1
  ...
  {
		'image': cloudy_bubbles,
		'src': 'img/layer_10_cloudy_bubbles.png',
		'z_index': 2,
		'position': {x: 0, y: 0},
		'blend': null,
		'opacity': 0.75
